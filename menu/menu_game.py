...
class MenuPlay:
    ...
    def mostrarMenuDificultad(self):
        self.fondoMenuDificultad = pygame.image.load(join("assets", "img", "Background", "menu", "Background_5.jpeg")).convert_alpha() # Fondo para menu de selección de dificultad
    ...
    def mostrarMenuNiveles(self, dificultadNivel):
        self.fondoMenuDificultad = pygame.image.load(join("assets", "img", "Background", "menu", "Background_5.jpeg")).convert_alpha()
