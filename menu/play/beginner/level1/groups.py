...
# from menu.play.beginner.level1.sprites import Sprite, Cloud
# from random import choice, randint
# from menu.play.beginner.level1.timerr import Timer
...
# 		sea_rect = pygame.FRect(0,horizon_pos,WIDTH,HEIGHT - horizon_pos)
# 		pygame.draw.rect(self.display_surface, '#92a9ce', sea_rect)

# 		# horizon line
# 		pygame.draw.line(self.display_surface, '#f5f1de', (0,horizon_pos), (WIDTH, horizon_pos), 4)
